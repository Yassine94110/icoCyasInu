...
contract IcoForCyasInu is Ownable {
    ...
    constructor(
        ...
        require(_rate > 0, "Le prix est nulle");
        require(_token != address(0), "Token address is 0");
        require(_closingTime > _openingTime, " closingTime <= openingTime ");
        rate = _rate;
        token = IERC20(_token);
    ...
    modifier icoFinished() {
        require(block.timestamp > closingTime, "ICO en cours ou pas start");
        _;
    }
